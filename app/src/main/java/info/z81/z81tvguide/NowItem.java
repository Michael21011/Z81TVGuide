...
public class NowItem {
	...
	public String getAgoTime()
	{
	    ...
	    diffString=String.format("%d min", diffMin);
	    if (diffMin>=60)
	    {
	    	long diffHour = diffMin/60;
	    	diffString=String.format("%d h.", diffHour);
	    }
		}
	    return diffString;
	}
	...
	public int getChannelLogo() {
		...
		else if (ChannelName.equalsIgnoreCase("НТВ-ПЛЮС КИНО ПЛЮСс")) {
		...
		else if (ChannelName.equalsIgnoreCase("Русский Экстрим")) {
